...
\newcommand{\getAff}[1]{
  \getIndex{#1}{deuc,ieb,uccs,ciba,geup,iact}
}
...
\begin{flushleft}
{\Large
\textbf\newline{The recent history of high elevation Lagunas Miscanti and Miñiques,
Chilean Altiplano, as revealed by biomarker study} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Matías Frugone-Álvarez\textsuperscript{1,2}\textsuperscript{\getAff{deuc,ieb}},
Claudio Latorre\textsuperscript{\getAff{deuc,ieb}},
Sergio Contreras\textsuperscript{\getAff{uccs,ciba,geup}},
Antonio Delgado-Huertas\textsuperscript{\getAff{iact}}\\
\bigskip
\textbf{\getAff{deuc}}Departamento de Ecología \& Centro UC Desierto de Atacama, Pontificia
Universidad Católica de Chile, Santiago, Chile.\\
\textbf{\getAff{ieb}}Instituto de Ecología y Biodiversidady (IEB), Santiago, Chile\\
\textbf{\getAff{uccs}}La Universidad Católica de la Santísima Concepción (UCSC)\\
\textbf{\getAff{ciba}}Centro de Investigación en Biodiversidad y Ambientes Sustentables
(CIBAS), Chile\\
\textbf{\getAff{geup}}Department of Geology and Environmental Science, University of
